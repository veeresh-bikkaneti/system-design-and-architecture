...
SOLID is five principles for never building that class in the first place. They come from
Robert C. Martin's writing on object-oriented design, collected under the SOLID acronym
in *Agile Software Development* (2002) and revisited in *Clean Architecture* (2017).
