...
<VideoCard videoId="pTB30aXS77U" title="Uncle Bob&#x27;s SOLID Principles Made Easy - In Python!" source="ArjanCodes" description="All five SOLID principles with practical Python examples and companion code — the &quot;why bother&quot; case from a veteran educator." />
...
<VideoCard videoId="u-dEc2z2uIA" title="Dependency Inversion Principle (D) - Software Design Patterns" source="The Software Mentor" description="Depend on abstractions, not concretions — a working engineer walks through the DIP with TypeScript code, when it pays off, and when it is overkill." />
