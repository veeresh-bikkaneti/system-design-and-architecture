...
- Marc Brooker, "Timeouts, Retries, and Backoff with Jitter," AWS Architecture Blog — exponential backoff with full jitter and why decorrelated randomization beats fixed schedules.
