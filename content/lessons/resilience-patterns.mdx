...
<VideoCard videoId="MscUun1GWu8" title="Episode 55 - What Happens When a Component Fails? | Building Resilient Systems" source="Anupam Tech Talks" description="Walks through what happens when a component fails — the case for resilient design." />
...
<VideoCard videoId="UySf6ivvGoM" title="💊 Designing for Failure: The Key to Robust Microservices Architecture" source="مصطفى سليمان" description="Covers timeouts, circuit breakers, and bulkheads — the wiring that keeps ships afloat." />
...
<VideoCard videoId="G_kExQGrbOs" title="Timeouts & Retries in Distributed Systems (Tuning for Reliability)" source="Mila Bay" description="Practical tuning guide for timeouts and retries in distributed systems." />
...
<VideoCard videoId="Lw8KExizlPQ" title="Ep. 29: Graceful Degradation: What You Need to Know" source="Systemic Stack English" description="Dedicated explainer on graceful degradation — your backup generator strategy." />
