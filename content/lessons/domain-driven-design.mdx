...
<VideoCard videoId="MKLRXCiU5IE" title="Reactive DDD: Modeling Uncertainty - Vaughn Vernon" source="SpringDeveloper" description="Vaughn Vernon traces DDD's core ideas and why they still guide today's distributed, event-driven systems." />
...
<VideoCard videoId="aozNdnfSDBs" title="Agile Book Club: Ubiquitous Language" source="James Shore" description="James Shore's book-club session explores building a shared domain vocabulary between experts and developers." />
...
<VideoCard videoId="am-HXycfalo" title="Bounded Contexts - Eric Evans - DDD Europe 2020" source="Domain-Driven Design Europe" description="Eric Evans himself explains bounded contexts and keeping each model coherent within its boundary." />
...
<VideoCard videoId="KkzvQSuYd5I" title="Mauro Servienti - Talk Session: All Our Aggregates Are Wrong" source="Explore DDD" description="Mauro Servienti shows where aggregate designs go wrong and how to draw consistency boundaries right." />
...
<VideoCard videoId="36HtWmAAH94" title="Domain Events: The Hidden Power Behind Software Architecture" source="EzzyLearning" description="Short explainer on what domain events are, why past-tense facts help, and raising them from aggregates." />
...
<VideoCard videoId="fGm62ra_mQ8" title="Alberto Brandolini - 100,000 Orange Stickies Later | Øredev 2019" source="Øredev Conference" description="EventStorming's creator walks through the sticky-note workshop technique for discovering domain models together." />
...
<VideoCard videoId="8EhH2oqK2-0" title="Automation Obsession: Are You Automating the Wrong Things? - Gojko Adzic &quot;Specification by Example&quot;" source="Pragmatic Talks" description="Gojko Adzic discusses capturing shared understanding with concrete examples before committing to automation." />
...
<VideoCard videoId="1dIjb9A4uow" title="Every Event, Everywhere, All at Once • Jacqui Read • GOTO 2025" source="GOTO Conferences" description="Jacqui Read tours event types, contrasting internal domain events with public integration events." />
...
<VideoCard videoId="JoPY0yfElK4" title="On .NET Live: Shaving the outbox pattern yak" source="dotnet" description="dotnet session on the outbox pattern's ideas, lessons learned, and alternatives from building it." />
...
<VideoCard videoId="nwzxyfsubyM" title="EventSourcing & CQRS: a light introduction - Paolo Banfi - DDD Europe 2022" source="Domain-Driven Design Europe" description="DDD Europe talk introducing event sourcing basics and how it fits with CQRS in real systems." />
...
- [EventSourcing & CQRS: a light introduction](https://www.youtube.com/watch?v=nwzxyfsubyM) — Paolo Banfi, DDD Europe 2022 (~49m). Ubiquitous language, bounded contexts, and aggregates framed through event sourcing — the lesson's "let events tell the story" angle, from DDD's own conference.
