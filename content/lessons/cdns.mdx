...
<VideoCard videoId="RI9np1LWzqw" title="What is a CDN?" source="ByteByteGo" description="ByteByteGo traces a request from your browser to the nearest edge cache — like grabbing a book from your local library branch instead of the national warehouse." />
...
<VideoCard videoId="b4_6thkYZXs" title="What is a CDN (Content Delivery Network)?" source="InterviewReady (Gaurav Sen)" description="InterviewReady shows why one central cache buckles and how geo-distributed edges take over — like swapping a single giant warehouse for stocked corner stores everywhere." />
...
<VideoCard videoId="HGAyuf0WIEQ" title="CDNs Explained — How Content Delivery Networks Make Websites Faster" source="NetWorks" description="Cache TTL, invalidation and purge, plus versioned and hashed files — the three freshness levers, and how edge PoPs route you to the nearest copy." />
