...
<VideoCard videoId="G2YyXlMH_5w" title="What is a CDN" source="Dargslan" description="Opens with the distance problem, then shows how CDNs cut latency, absorb traffic spikes, and shield origins." />
