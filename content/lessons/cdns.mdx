...
{/* ANIMATION: GlobeMap showing a request from Sydney hitting the local edge PoP vs traveling to a Virginia origin, with latency counters */}
...
new filenames. This one trick eliminates an entire class of staleness bugs.
...
- Nygren, Sitaraman & Wein, "Networked Systems and the Internet" / ACM SIGCOMM papers on CDN measurement — for the academic view of anycast and hit ratios.
