...
<VideoCard videoId="XP98YCr-iXQ" title="What is Database Sharding?" source="Anton Putra" description="A phone-book ledger maps each key to its shard — Anton covers directory sharding&#x27;s flexibility and its single-point-of-failure price tag." />
