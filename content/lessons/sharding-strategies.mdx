...
🎥 **Learn more:** [SD 11 | Database Sharding | System Design Course | Uplatz](https://www.youtube.com/watch?v=kKUsCSsBR3Y) — Uplatz. Uplatz walks through why one database hits a wall, what sharding is, and when to reach for it.
...
🎥 **Learn more:** [Partitioning & Sharding - Redis for Developers](https://www.youtube.com/watch?v=v68e9C6dnyI) — The Software Mentor. Redis Cluster's 16384 hash slots show how hashing keys spreads rows evenly, plus hash tags to co-locate related keys.
...
🎥 **Learn more:** [System Design Basics #13 — Sharding and Partitioning: When One Machine Isn't Enough](https://www.youtube.com/watch?v=TEWauzwcFco) — LLMwork. Walks through range-based sharding, the shard-by-date hotspot, and spreading fixes.
...
🎥 **Learn more:** [Data Sharding UNLEASHED: Top 4 Algorithms to Master Database Scalability & Performance #systemdesign](https://www.youtube.com/watch?v=POb4gbP9Y4o) — SystemDR - Scalable System Design. Explains lookup-table routing that maps keys to shards directly — flexible placement, but the directory becomes a bottleneck.
...
🎥 **Learn more:** [System Design Basics #14 — Consistent Hashing: Adding a Server Without Moving Everything](https://www.youtube.com/watch?v=qgsYShQhVZo) — LLMwork. Builds the hash ring from the modulo-hashing failure, showing why adding a server moves only ~1/N keys; covers virtual nodes.
...
🎥 **Learn more:** [Database Sharding Explained: Partitioning, Hot Keys, and Safe Resharding](https://www.youtube.com/watch?v=jvdGEilH1x8) — DevLevel13. Walks through resharding without an outage via dual-write and shadow reads, plus how hot keys drive migration cost.
...
🎥 **Learn more:** [Choosing a Shard Key](https://www.youtube.com/watch?v=qRfX0gPEP-s) — InterSystems Developers. Covers shard key criteria — cardinality, even distribution, query alignment — and when the default key is good enough.
