...
<VideoCard videoId="TcjA6iPoods" title="Distributed Transactions in Microservices | 2PC, Failures & Compensation | Episode 15" source="Avinash Explains Tech" description="Covers local vs distributed transactions, ACID limits across services, and the partial-failure problem that starts it all." />
...
<VideoCard videoId="skULExZgBSg" title="Two-Phase Commit (2PC) Explained: Pros, Cons & When to Use It" source="Escoding" description="Walks through the prepare and commit phases, why coordinators matter, and where 2PC makes sense." />
...
<VideoCard videoId="J5Iu3MUae5E" title="Three Phase Commit Explained: How Distributed Systems Stay Consistent | Reserve, Pre-Commit, Commit" source="Kartikeya Sharma" description="Shows how a coordinator crash leaves participants holding locks in an uncertain state — then how 3PC answers it." />
...
<VideoCard videoId="kyNL7yCvQQc" title="Not Just Events: Developing Asynchronous Microservices • Chris Richardson • GOTO 2019" source="GOTO Conferences" description="Richardson explains sagas as sequences of local transactions, covering orchestration and messaging for reliability." />
...
<VideoCard videoId="3hdQUcz1CA8" title="How to Never Silently Lose an Event | The Transactional Outbox Pattern" source="Ops and Odds" description="Demonstrates writing the event to an outbox table in the same transaction, plus polling vs CDC relay options." />
...
<VideoCard videoId="DOFflggE_0Q" title="Distributed Transactions Explained: 2 Phase Commit vs Saga Pattern" source="Hello Interview" description="Compares 2PC and sagas head-to-head, covers the outbox as the glue, and gives a practical verdict." />
...
- [Change Data Streaming Patterns in Distributed Systems](https://www.youtube.com/watch?v=CLv2EcYnr2g) — Gunnar Morling (Debezium lead) & Hans-Peter Grahsl, Berlin Buzzwords 2021. The outbox pattern and CDC-based saga orchestration, implemented live.
