...
{/* ANIMATION: StepThrough showing 2PC: prepare votes, coordinator crash, participants blocked holding locks, then recovery */}
...
- Jim Gray, "Notes on Data Base Operating Systems" (1978) — the paper that introduced two-phase commit.
