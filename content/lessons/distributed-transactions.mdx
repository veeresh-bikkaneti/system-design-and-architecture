...
<VideoCard videoId="OfE_GlT-QKo" title="Stop writing to two systems. Write to one." source="Metaphorically Speaking" description="A card-game metaphor shows why writing to the DB and the broker separately loses events — and how one outbox table fixes it." />
