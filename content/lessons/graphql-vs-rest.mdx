...
(You already know the front door from *API Gateways* and the per-client kitchen from *BFF:
One API Per Client*. This lesson is about what the menu looks like once you're inside.)
