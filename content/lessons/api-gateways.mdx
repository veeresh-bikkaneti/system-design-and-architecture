...
<VideoCard videoId="6ULyxuHKxg8" title="What is API Gateway?" source="ByteByteGo" description="Lines up gateways, reverse proxies, load balancers, and BFFs side by side." />
...
<VideoCard videoId="tmGnpU8xOGE" title="&quot;Backends for Frontends&quot;: what is it?" source="Software Developer Diaries" description="One concierge per client: why mobile, web, and TV each deserve their own tailor-made backend." />
