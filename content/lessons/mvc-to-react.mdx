...
<VideoCard videoId="4ZIUqnYGyWA" title="&quot;MVC With and Without a Framework&quot;, with Nolan Erck--CFMeetup #318" source="Charlie Arehart, CArehart" description="Conference talk showing how MVC keeps real codebases sane, framework or not — the payoff this lesson explains." />
...
<VideoCard videoId="NH6otflkHXs" title="MVC vs MVP vs MVVM — Quick Android Interview Tip (7 minutes)" source="Bijoy Android Interview Prep" description="Seven-minute side-by-side of MVC, MVP, and MVVM so the stricter variants click." />
