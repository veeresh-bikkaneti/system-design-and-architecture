...
<VideoCard videoId="3NzIxASfy5k" title="What is a Load Balancer" source="Dargslan" description="Uses a restaurant-host analogy to explain how requests get seated across servers, with clear visual flow." />
