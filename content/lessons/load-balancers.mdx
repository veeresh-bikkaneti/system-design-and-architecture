...
<VideoCard videoId="3NzIxASfy5k" title="What is a Load Balancer" source="Dargslan" description="20-minute visual explainer with an explicit &quot;restaurant-host analogy&quot; chapter, plus L4 vs L7, algorithms, and health checks in plain English. Caveat: non-trusted channel — quick audio check advised" />
...
<VideoCard videoId="XSZQescGmco" title="What is Load Balancing? Load Balancing Explained" source="Learn CS" description="Walks through hardware, software, and cloud balancer types plus L4 vs L7 with timestamped chapters — like sorting mail by address vs. reading the letter inside. Caveat: channel identity unverified; description is detailed human-written" />
...
<VideoCard videoId="Pe92aGH-Z9g" title="EP-09 AWS Application Load Balancer (ALB) Explained" source="Our Cloud School" description="Human walkthrough of listener rules, path-based routing, target groups, and health checks with a step-by-step EC2 demo. Caveat: non-trusted channel" />
