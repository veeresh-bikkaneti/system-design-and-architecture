...
<VideoCard videoId="d8NDgwOllaI" title="Microservices, Where Did It All Go Wrong - Ian Cooper - NDC London 2025" source="NDC Conferences" description="Cooper unpacks the misunderstandings that made a decade of microservices painful, and what each approach was meant to solve." />
...
<VideoCard videoId="NdeTGlZ__Do" title="Monolithic vs Microservice Architecture: Which To Use and When?" source="Alex Hyett" description="Walks through advantages and disadvantages of each style so you see what monoliths and microservices buy you." />
...
<VideoCard videoId="8lfeIdqwWDM" title="Architecture and Organization: Inverse Conway and Team Topologies" source="Adaptive Organizations meet Architecture" description="Explains how team structures shape software design, and how the inverse Conway maneuver lets you redesign teams deliberately." />
...
<VideoCard videoId="p2GlRToY5HI" title="Don&#x27;t Build a Distributed Monolith - Jonathan &quot;J.&quot; Tower - NDC London 2023" source="NDC Conferences" description="Consultant Jonathan Tower shows the classic ways microservices turn into a distributed monolith — like a house where every &quot;separate&quot; room still shares one thermostat and fuse box" />
...
<VideoCard videoId="I4dC_lqS_I8" title="You're Building Modular Monoliths All Wrong" source="CodeOpinion" description="Comartin shows how to draw true module boundaries with real data ownership inside one deployable monolith." />
...
<VideoCard videoId="GBTdnfD6s5Q" title="When To Use Microservices (And When Not To!) • Sam Newman &amp; Martin Fowler • GOTO 2020" source="GOTO Conferences" description="Sam Newman and Martin Fowler lay out a practical when-to-split checklist — like a home-inspection report before you buy into microservices" />
...
- [Serverless and Microservices with C# – Scalable Cloud Applications with Azure and .NET Aspire](https://www.youtube.com/watch?v=xHUwGx-ZlTM) — freeCodeCamp.org (~5h). Microservice patterns, onion architecture, and serverless in depth — the strongest long-form case for the microservices half.
