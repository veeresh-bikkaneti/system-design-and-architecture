...
<VideoCard videoId="9iW_2MMLd4w" title="Don't Build a Distributed Monolith: How to Avoid Doing Microservices Wrong - Jonathan J. Tower" source="NDC Conferences" description="Tower walks through ten common microservices mistakes that quietly produce a distributed monolith, and how to avoid them." />
...
<VideoCard videoId="sXVpQpsdjfQ" title="Monolith vs Microservices (Most Engineers Get This WRONG) | When to Use What (Interview Guide)" source="TechingEasy" description="Lays out when to use a monolith versus microservices, giving clear criteria for the architecture decision." />
