...
<VideoCard videoId="fRsajShniPk" title="Instagram's Architecture, Explained | System Design Breakdown | Episode 01" source="The Tech Intern" description="Breaks down Instagram's real architecture at scale, showing why each design choice matters." />
...
<VideoCard videoId="L3GLkH2oscw" title="System Design Episode 4 || Capacity Estimation & Back-of-the-Envelope Calculations" source="CodeTav Management" description="Walks capacity estimation with Instagram examples: users, storage, and bandwidth math." />
...
<VideoCard videoId="MUSRr7zeW6U" title="System Design | Sharding | Database Sharding vs. Partitioning: Scaling to Billions of Rows" source="CS AI Think Tinker Learn" description="Instagram case study on sharded metadata with embedded IDs that eliminate network round-trips." />
...
<VideoCard videoId="Ntj3lQpjxI8" title="System Design Basics #16 — CDNs and Blob Storage: Serving Files and Photos at Scale" source="LLMwork" description="Shows how photos move from blob storage to CDN edges so viewers fetch nearby copies." />
...
<VideoCard videoId="L9yitYWl8EY" title="System Design Essentials | Data Stores/DB | Graph Databases: Index-Free Adjacency, LPG vs RDF" source="CS AI Think Tinker Learn" description="Explains why graph stores handle follow relationships better than relational tables." />
...
<VideoCard videoId="_0M7ae-ddkM" title="Design Youtube Video Platform | System Design Interview" source="ScalaBrix" description="Covers multiple media renditions plus signed playback URLs for authorized access." />
...
<VideoCard videoId="cBTLq-MPhO4" title="Loading the Whole Social Graph OOM-Killed the Feed — Design Instagram" source="TheCodeForge" description="Catalogs real failure modes at scale: OOM kills, hot shards, thundering herds." />
...
<VideoCard videoId="jSAD5TDalsg" title="System Design Interview: Designing a Social Media Feed (Twitter/Instagram Scale)" source="Hybeecodes" description="Full mock-interview walkthrough of a social feed design, from requirements to architecture." />
