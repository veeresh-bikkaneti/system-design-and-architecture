...
<VideoCard videoId="0j2fXqXq4rk" title="Domain-Driven Design | Modeling Complex Enterprise Business Applications | Uplatz" source="Uplatz" description="Catalogs common DDD implementation mistakes — the overengineering warning to read first." />
