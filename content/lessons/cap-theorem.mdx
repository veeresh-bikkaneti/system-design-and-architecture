...
<VideoCard videoId="HK4-lYHa3RE" title="The CAP Theorem, Explained" source="NeuraForge" description="Covers how CAP drives real database and architecture decisions during network failures." />
...
<VideoCard videoId="bvO2dVqYjwg" title="What is the CAP Theorem" source="Dargslan" description="Uses a two-shop-tills everyday analogy to make the three CAP guarantees concrete and memorable." />
