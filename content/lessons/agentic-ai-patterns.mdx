...
🎥 **Learn more:** [Andrew Ng On AI Agentic Workflows And Their Potential For Driving AI Progress](https://www.youtube.com/watch?v=q1XFm21I-VQ) — Snowflake Developers. Andrew Ng shows why agentic workflows are the next leap, with examples that make it click.
...
🎥 **Learn more:** [Exploring Multi-Agent AI and AutoGen with Chi Wang](https://www.youtube.com/watch?v=RLwyXRVvlNk) — Foundation Capital. Chi Wang demos teams of agents splitting real work — the bullpen in action.
...
🎥 **Learn more:** [Agentic AI Explained: How AI Agents Actually Work](https://www.youtube.com/watch?v=Ncn6X3WxN9g) — Devsplainers. Walks the perceive-plan-act-observe loop end to end until the rhythm feels natural.
...
🎥 **Learn more:** [Agentic AI Design Patterns Explained — Part 3: ReAct, Loop, Review & Critique](https://www.youtube.com/watch?v=hB79ud9i150) — Byte Programming. Compares reacting on the fly with planning first, then critiquing the plan.
...
🎥 **Learn more:** [Multi-Agent Orchestration Explained: From Patterns to Production](https://www.youtube.com/watch?v=EtSO9vU84ws) — scrollypedia. Lays out five ways to coordinate agents, from one boss to a leaderless swarm.
...
🎥 **Learn more:** [How AI Agent Memory Actually Works: Trimming, Compaction & Summarization](https://www.youtube.com/watch?v=84OKrJNRGKg) — Learn the Technology with Brandon Krakowsky. Explains how agents remember things: trimming, compaction, and summarization.
...
🎥 **Learn more:** [Cheap Tokens, Expensive Tasks | AI Daily](https://www.youtube.com/watch?v=kNhQMgOOyc4) — BirenAI. Does the real math: turns, retries and caching multiply token spend into cost per task.
...
🎥 **Learn more:** [Agents the New microservices problem](https://www.youtube.com/watch?v=3th_XHwY7k4) — AWSLondonON Meetup. A frank look at how agent systems break down once real users show up.
...
🎥 **Learn more:** [What is: Agentic Looping?](https://www.youtube.com/watch?v=d3YMDV1OYSs) — Postman. Covers iteration caps, progress checks, and token budgets — the rules that keep loops honest.
