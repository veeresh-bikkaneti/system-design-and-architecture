...
- [Learn Live - Understand API gateways in a cloud-native ASP.NET Core microservice](https://www.youtube.com/watch?v=ts-ePrQmEe0) — Microsoft Developer. A hands-on build of per-client backends with decoupled releases.
