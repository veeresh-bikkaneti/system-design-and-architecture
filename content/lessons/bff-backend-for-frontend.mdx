...
<VideoCard videoId="PwgQZ8eCGxA" title="Why Backend for Frontend Is Key for Microservices • Brian Grant & Krishnan Ramanathan • GOTO 2017" source="GOTO Conferences" description="A Morningstar case study making the business case for BFFs in microservices." />
...
<VideoCard videoId="SUyKohjyhq0" title="Backend for Frontend (BFF) with Angular and tRPC" source="Christian Lydemann" description="Plain-language tour of what a BFF is and why frontends need one." />
...
<VideoCard videoId="jfN6HOgURXM" title="microXchg 2016 - Bora Tunca : BFF Pattern in Action: SoundCloud’s Microservices" source="microXchg" description="SoundCloud's origin story: one API buckled under web, mobile, and partner needs." />
...
<VideoCard videoId="RPp4Z1qKf6M" title="Meet Your New BFF: Backend to Frontend without the Duct Tape • Noam Honig • Devoxx Poland 2023" source="Devoxx Poland" description="Shows the pattern live in a modern stack: one dedicated backend per frontend." />
...
<VideoCard videoId="GLp2RccPPIo" title="Backends for frontends with GraphQL by Pavels Jelisejevs from C.T.Co at FrontCon 2018" source="DEVCLUB LV" description="Draws the BFF layer between clients and microservices, showing its place in the stack." />
...
<VideoCard videoId="gkSbAQqXmSo" title="BFF4EAE: Your Backend's New Best Friend Forever - Stacy Devino | droidcon USA 2026" source="nextapp devCon" description="A production BFF talk with honest notes on when the pattern becomes overkill." />
