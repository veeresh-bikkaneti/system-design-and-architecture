...
<VideoCard videoId="Bnrk9Jz5ko0" title="Lambda vs Kappa Architecture | Batch vs Stream Processing Explained" source="Arpit Vaish" description="Explains why Lambda architecture exists: batch layer for correctness plus speed layer for freshness, then its dual-codebase costs." />
