...
<VideoCard videoId="ukH_EQDhDBM" title="Why Distributed Data Lies to You (Replication & Consistency Explained)" source="The Logic Blueprint" description="Shows why distributed data misleads you — the honest case for studying replication." />
...
<VideoCard videoId="9_kqVxgpnbk" title="System Design: Data Replication Strategies Explained" source="AI & Systems Engineering" description="Compares leader and leaderless replication strategies with clear system-design framing." />
...
<VideoCard videoId="2qkVSJ9QbQA" title="SD 6 | Consistency Models: Strong vs Eventual | System Design Course | Uplatz" source="Uplatz" description="Strong versus eventual consistency explained — what clients actually observe." />
