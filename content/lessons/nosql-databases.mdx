...
<VideoCard videoId="5ikm8V2KnHM" title="System Design Basics #8 — SQL vs. NoSQL: Choosing Without the Religion" source="LLMwork" description="Even-handed SQL versus NoSQL guide that picks tools without the tribalism." />
...
<VideoCard videoId="J85fQ5gXEUM" title="The Truth About NoSQL: When to Use It (And When to Run)" source="deferstech" description="Walks CAP and PACELC across NoSQL families including Dynamo-style and wide-column stores." />
