...
<VideoCard videoId="l7yVGitPGl4" title="Building a Scalable Key-Value (Redis , DynamoDB) Store from Scratch" source="Arpit Vaish" description="Builds a scalable key-value store from scratch — labels, lookups, and speed, demystified." />
