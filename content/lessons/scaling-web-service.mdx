...
<VideoCard videoId="865BgE1gbPA" title="The Truth About Scaling: Why More Servers Isn't Always Better" source="Tahir Alvi" description="Traces how one server becomes a bottleneck and why scaling is a deliberate response to real bottlenecks, not a default." />
...
<VideoCard videoId="wbPOANluZN4" title="Horizontal vs Vertical Scaling: How to Handle Million Users | System Design Ep 2" source="Vishal Kumar" description="Uses a restaurant analogy to make horizontal and vertical scaling concrete, building the mental model this stage needs." />
...
<VideoCard videoId="X5wt11TVEKo" title="Vertical vs Horizontal Scaling: Bigger Box or More Boxes?" source="The Hot Path" description="Shows exactly where one server hits its limits and why vertical scaling eventually stops working — Stage 0's core lesson." />
...
<VideoCard videoId="sCR3SAVdyCc" title="What is a Load Balancer?" source="IBM Technology" description="The load balancer plays host at the restaurant door — greeting each request and seating it at the least-busy server so no single cook gets buried." />
...
<VideoCard videoId="GeGxgmPTe4c" title="Distributed Consensus and Data Replication strategies on the server" source="Gaurav Sen" description="Covers primary/replica split, replication lag, and read-your-own-writes with clear visual explanations." />
...
<VideoCard videoId="JcufU5dtBYQ" title="Redis Cache Explained in 300 Seconds (Beginner to Pro) #redis #cache #coding #seniordeveloper" source="Coding With Raj Dave" description="Covers cache-aside, TTL, and eviction policies with Redis in a compact format." />
...
<VideoCard videoId="9254n-FM97M" title="What is a CDN? - #Cloudbits Episode 2" source="Cloudflare Developers" description="Cloudflare's own explainer on what CDNs are and how edge caching works." />
...
<VideoCard videoId="cYskVBOxOHQ" title="System Design Part 5: Indexing & Sharding Explained (Scale to Millions)" source="Coding Devs" description="Covers sharding strategies, shard keys, hot shards, and cross-shard query costs for write scaling." />
...
<VideoCard videoId="IxkSlnrRFqc" title="SREcon19 Europe/Middle East/Africa - Advanced Napkin Math: Estimating System..." source="USENIX" description="SREcon talk on estimating system performance from first principles, matching the napkin-math discipline." />
...
<VideoCard videoId="Z_D3esVduTk" title="System Design Explained: How Apps Scale to 1 Billion Users" source="TheBinaryBreakdown" description="Rebuilds the whole journey from one server to global architecture: load balancers, caching, replicas, sharding, CDN." />
...
- [The Greeter. Load balancing, stateless servers, and horizontal scale. Learning Maps Ep.10](https://www.youtube.com/watch?v=n7mYiBIhNqA) — Organic Arts LLC. AI-narrated alternative.
