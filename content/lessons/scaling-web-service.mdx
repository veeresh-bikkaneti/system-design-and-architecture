...
Before we leave the database behind, one more trick — and it's the highest-leverage one on
this whole list. Some questions get asked *constantly*: "what's today's special?", "is the
...
But — and the style guide of engineering honesty requires this "but" — sharding is the
most expensive stage on this list. Queries that used to touch one database now might touch
