...
<VideoCard videoId="HftLmLLbJMU" title="What is Database Replication" source="Dargslan" description="Covers primary/replica split, replication lag, and read-your-own-writes with clear visual explanations." />
