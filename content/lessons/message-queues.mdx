...
<VideoCard videoId="mVDdjsIQ8K4" title="System Design Basics #17 — Message Queues: Decoupling Systems With Async Processing" source="LLMwork" description="Shows how a queue turns an 8-second upload into async work, with buffering, retries, and decoupling benefits" />
