...
<VideoCard videoId="il3vVUszSwA" title="SD 26 | Rate Limiting Algorithms: Token Bucket & Leaky Bucket | System Design Course | Uplatz" source="Uplatz" description="Step-by-step on token bucket and leaky bucket — the two classic limiting algorithms." />
