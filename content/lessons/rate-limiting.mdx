...
<VideoCard videoId="5D-dZvgEXi0" title="What is Rate Limiting" source="Dargslan" description="Covers why rate limits exist — protecting APIs from abuse, overload, and spiraling cost." />
...
<VideoCard videoId="s9JUA0d4pQ0" title="Rate Limiting Explained: The System Design Control That Stops Request Floods" source="The Logic Blueprint" description="Explains bursts, steady-state limits, and graceful 429s — limiting with fairness." />
