...
🎥 **Learn more:** [SD 26 | Rate Limiting Algorithms: Token Bucket & Leaky Bucket | System Design Course | Uplatz](https://www.youtube.com/watch?v=il3vVUszSwA) — Uplatz. Step-by-step on token bucket and leaky bucket — the two classic limiting algorithms.
...
- [Token bucket vs leaky bucket, rate limiting explained](https://www.youtube.com/watch?v=41H7TQl1IfU) — YouTube tutorial (~11 min). The two classic algorithms, the fixed-window exploit, and sliding windows.
- [Rate Limiter Explained: 4 Algorithms + Interview Q&A](https://www.youtube.com/watch?v=YVxYnYmZC6E) — YouTube tutorial (~20 min). From fixed window to token bucket, then the multi-server problem: Redis races and 429s.
