...
<VideoCard videoId="EWOcjCG1B8s" title="AI System Design Interview | Most Asked FAANG System Design Question" source="AmanAI Lab" description="Full URL-shortener walkthrough that explicitly answers every follow-up an interviewer is likely to ask." />
