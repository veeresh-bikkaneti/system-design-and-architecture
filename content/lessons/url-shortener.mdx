...
<VideoCard videoId="tvmt2HqpGhU" title="SD 14 | Consistent Hashing | System Design Course | Uplatz" source="Uplatz" description="Explains modulo hashing limits and consistent hashing for adding shards with minimal remapping." />
