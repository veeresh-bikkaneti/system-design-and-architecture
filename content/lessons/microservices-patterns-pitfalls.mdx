...
<VideoCard videoId="ECUd5FuK5q4" title="Understanding Progressive Collapse: How To Avoid A Cascading Failure" source="InfoQ" description="Sam Newman shows real post-mortems where small failures cascaded, proving why distributed pitfalls deserve serious attention." />
...
<VideoCard videoId="CzAmPAuEGpI" title="Granularity and Communication  in Microservices Architectures - Neal Ford" source="Developer Summit" description="Neal Ford teaches the architecture quantum technique for finding right-sized service boundaries and measuring coupling." />
...
<VideoCard videoId="a2WbPgrxALI" title="Jonathan Tower | How to Avoid Doing Microservices Completely Wrong" source="Update Conference" description="Tower names the distributed monolith and walks through mistakes that keep services from deploying independently." />
...
<VideoCard videoId="s4DFikOxFd0" title="The Chatty Service Anti-Pattern | Why Too Many Microservice Calls Slow You Down" source="Jay Reboul" description="Explains how excessive synchronous service-to-service calls add latency and fragility, plus batching and aggregation fixes." />
...
<VideoCard videoId="eZocOdvxFh8" title="Should Each Microservice Have Its Own Database or Table?" source="Ram N Java" description="Walks through why shared tables break service independence and how database-per-service restores ownership and scaling." />
...
<VideoCard videoId="Rk1gL9w8L14" title="Loose Coupling Isn’t Free — The Cost of Event-Driven Systems" source="Systems Thinking for Architects" description="Unpacks temporal coupling: event ordering and hidden timing dependencies that quietly re-couple services." />
...
<VideoCard videoId="5rt6-rndQQA" title="Monoliths vs Microservices: Are We Overcomplicating Everything?" source="SEEKJobs" description="SEEK engineers weigh when monoliths beat microservices, covering team size, complexity, and ownership trade-offs." />
...
- [Microservices with FastAPI – Full Course](https://www.youtube.com/watch?v=Cy9fAvsXGZA) — freeCodeCamp.org (~1.5h). Real inventory and payment microservices with Redis Streams, internal HTTP, and background tasks — patterns in practice.
- [Event Sourcing – You are doing it wrong](https://www.youtube.com/watch?v=GzrZworHpIk) — David Schmitz, Devoxx 2018 (~43m). The pitfalls half — why "every microservice gets its own database and then use Kafka" blows up in production, from large finance and insurance migrations.
