...
<VideoCard videoId="V-UFVf8a31o" title="Multi-AZ Won’t Save You | AWS (SOA-C02) Ep 9" source="Cram Exam" description="Shows how a whole region failing takes everything offline, making the case for multi-region design." />
