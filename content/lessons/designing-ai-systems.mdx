...
<VideoCard videoId="5NDuQGHM-ws" title="Building the Right AI Architecture" source="Practical AI" description="Rackspace's chief AI officer explains why AI success needs architecture beyond the model: compute, data, inference, orchestration, governance." />
...
<VideoCard videoId="smzw0JCWxlE" title="LLM Ops Architecture: Implementing Output Validation and Structured AI Responses" source="Analytics Vidhya" description="Analytics Vidhya walkthrough of a complete LLM app: FastAPI endpoints, RAG request pipeline, guardrails, fallbacks, structured responses." />
...
<VideoCard videoId="KHzA4ijpjKY" title="The Anatomy of AI Agents - Part 1: How LLMs Actually Work" source="BlueRider.Software" description="41-minute tech talk tracing a single inference: tokenization, next-token prediction, temperature, autoregressive generation, structured output." />
...
<VideoCard videoId="qN_2fnOPY-M" title="Local Retrieval Augmented Generation (RAG) from Scratch (step by step tutorial)" source="Daniel Bourke" description="Daniel Bourke explains why LLMs need retrieval, then builds a working RAG pipeline from scratch: chunking, embeddings, search, generation." />
...
<VideoCard videoId="R7Dv2h3tYCU" title="AI Agents in Practice • Henrik Kniberg • GOTO 2025" source="GOTO Conferences" description="GOTO talk defines AI agents, covers tools and agent architecture with practical design tips." />
...
<VideoCard videoId="e3VMKZeauoM" title="[AI Stack 15] Vector Databases vs. Traditional Search: What You Need to Know" source="The AI Stack" description="Explains how meaning becomes geometry: embeddings, cosine similarity, ANN indexes like HNSW, and tools like FAISS, pgvector, Pinecone." />
...
<VideoCard videoId="lxjWiVuK5cA" title="Optimize LLM inference with vLLM" source="Red Hat" description="Red Hat engineer and vLLM contributor explains PagedAttention, continuous batching, and prefix caching for efficient LLM serving." />
...
<VideoCard videoId="4gI52y0hyi8" title="Build an Eval Loop for More Reliable Agents (Evals 101)" source="Mastra" description="Mastra team workshop on eval loops: scorers, LLM judges, regression tests, dataset experiments, and monitoring production traces." />
...
- [System Design for AI Agents – Building a Multi-Agent PR Reviewer](https://www.youtube.com/watch?v=iqRcGCah0Kw) — freeCodeCamp.org (~3h 11m). Agents and inference at scale: orchestration, storage tiers, Redis queues, observability, and cost.
