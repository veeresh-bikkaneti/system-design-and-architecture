...
3. **Fine-tuning teaches behavior; RAG teaches facts.** Use both: fine-tune for house style, retrieve for knowledge. The VsToggle above is the decision in one screen.
