...
<VideoCard videoId="6YCrvZRFfmA" title="12. Metrics, Logs & Traces (Observability Explained)" source="Arpit Vaish" description="Walks through metrics, logs, and traces — and shows why traces settle debugging arguments." />
