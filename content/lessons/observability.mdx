...
answer questions about themselves — especially questions you didn't think to ask in advance.
...
- **Tail-based sampling** — buffer spans, decide after seeing the outcome: keep 100% of
  errors and slow requests, 0.1% of the boring successes. Needs a collector
...
{/* ANIMATION: TraceView showing a request's span tree with the slowest span highlighted, then drilling into its logs */}
...
5-minute spike that consumes 2% of the monthly budget is not a page; a sustained burn that
...
- Google SRE Book (site reliability workbook), Ch. 4–6 — SLIs, SLOs, and error budgets; free online at sre.google.
