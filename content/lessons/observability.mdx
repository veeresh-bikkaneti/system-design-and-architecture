...
<VideoCard videoId="ReaWg3UuqAk" title="The Three Pillars of Observability" source="Dargslan" description="Explains monitoring versus observability and why unknown-unknowns demand more than dashboards." />
...
<VideoCard videoId="IsvbbhQV-DA" title="Observability, Monitoring & Telemetry Explained | Logs, Metrics, Traces & APM" source="OnePercentEngineers" description="Covers RED, USE, and the Four Golden Signals — exactly what to measure and why." />
...
<VideoCard videoId="wf3mlWX1L5Q" title="Prometheus and Metrics" source="Dargslan" description="Shows how Prometheus labels turn one metric into many series — and where the bill hides." />
...
<VideoCard videoId="F9EDB-PYstI" title="10 SRE Concepts Every DevOps/SRE Engineer Must Master — Visual Deep Dive" source="DevXOps Tech" description="Visual deep dive of the core SRE concepts behind mature, adult alerting practices." />
