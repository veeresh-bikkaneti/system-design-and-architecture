...
1. **Stateless processes.** Your stall keeps no private memories — same rule as
   ...
   lives in a **backing service** outside the tray. A factor-XII app treats its
...
5. **Twelve-factor's big three:** keep processes stateless, put config in the
   environment, and treat databases and queues as attached backing services. The
   cloud will kill your processes; design so you don't mind.
