...
🎥 **Learn more:** [Getting Started with Cloud Native Infrastructure: Do's, Don'ts, and Lessons from the Ground](https://www.youtube.com/watch?v=UlDfNC3I15k) — Microsoft Developer. Covers what cloud native means and why teams need it, with do's and don'ts.
...
🎥 **Learn more:** [Microservices explained - the What, Why and How?](https://www.youtube.com/watch?v=rv4LlmLmVWk) — TechWorld with Nana. Explains microservices vs monoliths, tradeoffs, and how services communicate.
...
Virginia doesn't touch Ireland. Traffic between regions crosses the public internet,
so it's slow and metered.
...
🎥 **Learn more:** [AWS Global Architecture Explained: Multi-Region, Multi-AZ & EKS Clusters](https://www.youtube.com/watch?v=UFiHrikA6dc) — MrKnowledgeShare. Shows multi-AZ and multi-region AWS design with failover drills and RTO/RPO basics.
...
🎥 **Learn more:** [🚀 SaaS vs Self-Hosted vs Hybrid: How to Choose the Right Deployment Model?](https://www.youtube.com/watch?v=QtoMOgR2Ti4) — DataMuscle. Compares SaaS, self-hosted, and hybrid models with a practical decision framework for choosing.
...
flowchart LR
    ...
    S --> N1[Counter<br/>Node 1]:::cloud
    S --> N2[Counter<br/>Node 2]:::cloud
```
...
🎥 **Learn more:** [Kubernetes Architecture Explained in 7 Minutes \[2026\]](https://www.youtube.com/watch?v=oxUrkY6qY4o) — QA SECRET. Explains pods, nodes, and the control plane — how Kubernetes schedules containers like a shift manager.
...
🎥 **Learn more:** [Defining Serverless Architecture | Crash Course](https://www.youtube.com/watch?v=hCCMri3jFAo) — MSFTImagine. Breaks down serverless architecture, loose coupling, and autoscaling through simple demos.
...
🎥 **Learn more:** [27. The Twelve-Factor App](https://www.youtube.com/watch?v=2_fcv3-XfN4) — Sriniously. Walks through all twelve factors, their history, and a live deployment demo.
...
🎥 **Learn more:** [Cloud Billing with FinOps: Tips, Mistakes and Surprises](https://www.youtube.com/watch?v=lsbgc8bE3lo) — FinOps Weekly. FinOps specialist unpacks cloud billing surprises, invoice reconciliation, and cost accountability.
...
- [The Future of Serverless](https://www.classcentral.com/course/youtube-the-future-of-serverless-nick-coult-goto-2025-488152) — Nick Coult (AWS), GOTO Serverless 2025 (28 min). Serverless fundamentals: events, cold starts, and cost.
